@extends('layouts.app')
@push('css')
    <link href="{{ asset('/themes/mytravel/dist/frontend/module/tour/css/tour.css?_ver='.config('app.version')) }}" rel="stylesheet">
...
@push('js')
    ...
    <script type="text/javascript" src="{{ asset('/themes/mytravel/module/tour/js/single-tour.js?_ver='.config('app.version')) }}"></script>
@endpush
