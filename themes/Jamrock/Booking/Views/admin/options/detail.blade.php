...
@section('content')
    <form action="{{route('options.admin.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}" method="post">
        @csrf
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar">{{$row->id ? __('Edit: ').$row->title : __('Add Dropdown Option')}}</h1>
                </div>
            </div>
            <input type="hidden" name="dropdown_id" value="{{$dropdown_id}}">
                    ...
                    <div class="col-md-9">
                        <div class="panel">
                            <div class="panel-body">
                                @include('Booking::admin.options.form')
