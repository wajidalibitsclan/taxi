...
@section('content')
    <form action="{{route('combination.admin.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}" method="post">
        @csrf
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar">{{$row->id ? __('Edit: ').$row->title : __('Add Combination')}}</h1>
                </div>
            </div>
                    ...
                    <div class="col-md-9">
                        <div class="panel">
                            <div class="panel-body">
                                @include('Booking::admin.combination.form')
