<div class="form-checkout " id="form-checkout" >
            ...
            <div class="col-6 field-country pr-0">
                ...
                <div class="col-6 pl-0">
                    <div class="form-group c_code">
                        <label >{{__("Phone")}} <span class="required">*</span> <i class="fa fa-info-circle" style="color: #0a58ca" data-toggle="tooltip" data-placement="top" title="Please include your country code"></i></label>
    ...
    <div class="form-group">
        <label class="term-conditions-checkbox" style="font-size: 13px;">
           {{__('I have read and accept the')}}  <a target="_blank" data-toggle="modal" href="#term_conditions">{{__('terms and conditions')}} </a>  <input type="checkbox" name="term_conditions">
        </label>
    </div>
...
<!--    <div class="form-actions">
    ...
    <div class="d-flex justify-content-between">
        <a href="{{url()->previous()}}" class="btn btn-secondary" style="min-width: 105px">Back</a>

        <button type="button" class="btn btn-primary" style=" width: 102px; background: #00B050"> {{format_money($booking->total)}}</button>
