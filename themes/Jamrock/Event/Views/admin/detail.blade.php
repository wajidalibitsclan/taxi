                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label">{{__("Display Order")}}</label>
                                    <input type="number" name="display_order" class="form-control" value="{{$row->display_order}}">
                                </div>
...
@push("js")
    <script>
        var json_column_pax = {!! json_encode($row->pax_ranger??[]) !!};

        var json_distance = {!! json_encode($distance??[]) !!};

        var json_rangers = {!! json_encode($rangers??[])!!};

    </script>
    {!! App\Helpers\MapEngine::scripts() !!}
    <script src="{{asset('themes/jamrock/js/admin/price-table.js')}}"></script>
    <script>
        jQuery(function ($) {
