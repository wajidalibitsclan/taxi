...
<div class="form-group">
    ...
    <div class="form-content">
        ...
        <div class="smart-search">
            <input type="text" class="smart-search-location parent_text form-control" {{ ( empty(setting_item("event_location_search_style")) or setting_item("event_location_search_style") == "normal" ) ? "readonly" : ""  }} placeholder="{{__("Or filter by event locaiton")}}" value="{{ $location_name }}" data-onLoad="{{__("Loading...")}}"
