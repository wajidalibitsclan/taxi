        ...
        <div class="content justify-content-between">
            ...
            <div class="header-right" style="flex-shrink: 0;width: auto">
                ...
                <a href="#" class="bravo-more-menu icon-service h-badge">
                    <span class="">
                        <img src="{{asset('themes/jamrock/images/new-image17.png')}}" alt="">
                    </span>
                </a>
                <a href="javascript:void(0)" class="icon-service h-badge">
                   <span class="">
                        <img src="{{asset('themes/jamrock/images/new-image14.png')}}" alt="">
                    </span>
                </a>
                <a href="{{ route('tour.search') }}" class="icon-service h-badge">
                   <span class="">
                        <img src="{{asset('themes/jamrock/images/new-image15.png')}}" alt="">
                    </span>
                </a>
                <a href="{{ route('car.search') }}" class="icon-service h-badge">
                    <span class="">
                        <img src="{{asset('themes/jamrock/images/new-image13.png')}}" alt="">
                    </span>
                </a>

<!--                <a href="{{ route('event.search') }}" class="icon-service">
...
{{--                <i class="icofont-scroll-left"></i>--}}
                <img style="width: 50px" src="{{asset('themes/jamrock/images/mobile_manu_close.png')}}" alt="">
            </div>
