        ...
        <div class="row">
            <div class="col-md-4 mb40">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form action="{{route('faq.admin.category.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}" method="post">
                            @csrf
                            @include('Faq::admin/category/form',['parents'=>$rows])
                            <div class="">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        @if(!empty($rows))
                            <form method="post" action="{{route('faq.admin.category.bulkEdit')}}" class="filter-form filter-form-left d-flex justify-content-start">
                                {{csrf_field()}}
                    ...
                    <div class="col-left">
                        <form method="get" action="{{route('faq.admin.category.index')}} " class="filter-form filter-form-right d-flex justify-content-end" role="search">
                            ...
                            <table class="table table-hover">
                                ...
                                @if( count($rows) > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="title">
                                            <a href="{{route('faq.admin.category.edit',['id'=>$row->id])}}">{{$prefix.' '.$row->name}}</a>
                                        </td>
