<section data-anim-wrap class="masthead -type-2 js-mouse-move-container">
    <div class="masthead__bg bg-dark-3">
        <img src="{{ asset("themes/GoTrip/img/masthead/2/bg.png") }}" alt="image">
    </div>
                        ...
                        <div class="tabs__controls d-flex items-center js-tabs-controls">
                            ...
                            <div class="">
                                <button class="tabs__button px-30 py-20 sm:px-20 sm:py-15 rounded-4 fw-600 text-white js-tabs-button @if($j == 0) is-tab-el-active @endif" data-tab-target=".-tab-item-{{$key}}">
                                    <i class="icon-{{$service['icon']}} text-20 mr-10 sm:mr-5"></i>
                                    {{$service['name']}}
                                </button>
                            </div>
                                @php $j++ @endphp
            ...
            <div class="row y-gap-40">
                ...
                <div class="col-xl-7">
                    <div class="masthead__images">
                        <div data-anim-child="slide-up delay-6"><img src="{{ asset("themes/GoTrip/img/masthead/2/1.png") }}" alt="image" class="js-mouse-move" data-move="30"></div>
                        <div data-anim-child="slide-up delay-7"><img src="{{ asset("themes/GoTrip/img/masthead/2/2.png") }}" alt="image" class="js-mouse-move" data-move="40"></div>
                        <div data-anim-child="slide-up delay-8"><img src="{{ asset("themes/GoTrip/img/masthead/2/3.png") }}" alt="image" class="js-mouse-move" data-move="50"></div>
                    </div>
                </div>
            </div>
        </div>
