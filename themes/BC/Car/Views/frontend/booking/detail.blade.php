    ...
    <div class="booking-review-content">
        ...
        <div class="review-section">
            <ul class="review-list">
                ...
                @foreach($booking->extras as $booking_extra)

                    <li>
                        <div class="label">{{$booking_extra->extra->title ?? $booking_extra->id}} x {{$booking_extra->number}}</div>
                        <div class="val">
                            {{format_money($booking_extra->price * $booking_extra->number)}}
                        </div>
                    </li>
                @endforeach
            </ul>
