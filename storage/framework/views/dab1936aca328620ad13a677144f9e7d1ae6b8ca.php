    ...
    <div class="container">
        ...
        <div class="right">
            <?php if($row->getBookingEnquiryType() === "book"): ?>
                <a class="btn btn-primary bravo-button-book-mobile" id="myCheck" ><?php echo e(__("Book Now")); ?></a>
            <?php else: ?>
...
<?php /**PATH /var/www/testing.jamaicataxi.com/htdocs/themes/BC/Car/Views/frontend/layouts/details/form-book-mobile.blade.php ENDPATH**/ ?>