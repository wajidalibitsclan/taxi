                ...
                <div id="formBookContent" class="border border-primary rounded">
                    ...
                    <div class="form-book-row d-flex justify-content-between">
                        ...
                        <div class="form-floating border-right border-primary d-block d-md-none">
                            <input v-model="pickup_date" type="date" placeholder="yyyy-mm-dd" min="<?php echo e(date('Y-m-d')); ?>" style="height: auto; padding-top: 0; margin-top: 32px;" class="form-control bg-white" >
                        ...
                        <div class="form-floating d-block d-md-none">
                            ...
                            <input type="time" format="HH:mm" placeholder="0" min="0" v-model="pickup_time" style="height: auto; padding-top: 0; margin-top: 32px;" class="form-control display-time" >
                             </span>
                            <label class="always-top" for="return" ><?php echo e(__('Pickup Time')); ?></label>
                    ...
                    <div class="form-book-row d-flex justify-content-between" v-if="!trip_type_selected">
                        ...
                        <div class="form-floating border-right border-primary d-block d-md-none">
                            <input v-model="return_date" type="date" placeholder="yyyy-mm-dd" min="<?php echo e(date('Y-m-d')); ?>" style="height: auto; padding-top: 0; margin-top: 32px;" class="form-control bg-white" >
                            <label for="return"  ><?php echo e(__('Return Date')); ?></label>
                        </div>
                        ...
                        <div class="form-floating d-block d-md-none">
                            ...
                            <span class="vue__time-picker h-100">
                            <input type="time" format="HH:mm" placeholder="0" min="0" v-model="return_time" style="height: auto; padding-top: 0; margin-top: 32px;" class="form-control display-time" >
                             </span>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/testing.jamaicataxi.com/htdocs/themes/Jamrock/Car/Views/frontend/layouts/details/form-book.blade.php ENDPATH**/ ?>