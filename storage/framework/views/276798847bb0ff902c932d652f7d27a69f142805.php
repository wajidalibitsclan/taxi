...
<div class="g-faq border-0" style="margin-bottom: 100px !important">
    <h3 class="d-flex justify-content-start align-items-center">



        <a href="javascript:viod(0)" class="show_hide_map  pl-1" style="padding: 5px 10px !important;">SHOW FAQs</a>

    </h3>


    <div class="results_faq" style="display: none;">
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        $('.show_hide_map').click(function() {
            if ($('.results_faq').css('display') == 'block') {
                $('.results_faq').toggle("slide");
                $('.g-faq').attr('style', 'margin-bottom: 100px !important');
                $(this).html('SHOW FAQs')
            }else{
                $('.results_faq').toggle("slide");
                $('.g-faq').attr('style', 'margin-bottom: 0px !important');
                $(this).html('HIDE FAQs')
            }
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/saeeccmd/taxi.saeedantechnology.com/themes/BC/Car/Views/frontend/layouts/details/detail.blade.php ENDPATH**/ ?>