<?php if($row->banner_image_id): ?>
    <div class="bravo_banner" style="background-size:contain !important;  background-image: url('<?php echo e($row->getBannerImageUrlAttribute('full')); ?>')">

        <div class="text-right pull-right mt-3" style="max-width: 80px;">
...
<?php /**PATH /home/saeeccmd/taxi.saeedantechnology.com/themes/BC/Car/Views/frontend/layouts/details/banner.blade.php ENDPATH**/ ?>