    ...
    <div class="g-field-search">
        ...
        <div class="row">
            ...
            <div class="col-md-6 border-right">
                <?php echo $__env->make('Car::frontend.layouts.search-map.fields.location',['prefix'=>"pickup_",'title' => __("Where from?"),'title_input' => __("Enter your pickup location"),'show_popup_location'=>1,'name'=>'pick_up'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            <div class="col-md-6 border-right">
                <?php echo $__env->make('Car::frontend.layouts.search-map.fields.location',['prefix'=>"dropoff_",'title' => __("Where To?"),'title_input' => __("Enter your dropoff location"),'name'=>'drop_off'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        var mapEngine = new BravoMapEngine('car_hidden_map',{
            center:[<?php echo e(setting_item('car_map_lat_default','0')); ?>, <?php echo e(setting_item('car_map_lng_default','0')); ?> ],
            zoom:<?php echo e(setting_item('car_map_zoom_default','6')); ?>,
            disableScripts:true,
            autoCallRoute:true,
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Applications/MAMP/htdocs/jamaica_texi copy/themes/Jamrock/Car/Views/frontend/layouts/search/form-search.blade.php ENDPATH**/ ?>