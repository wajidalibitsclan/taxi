...
<!--        <div class="duration">
        ...
        <div class="g-price">
            ...
            <div class="price">
                ...
                <span class="text-price"><?php echo e($row->display_price); ?> PP</span>
            </div>
        </div>
    </div>
    </div>
...
<?php /**PATH /Applications/MAMP/htdocs/jamaica_texi copy/themes/Jamrock/Tour/Views/frontend/layouts/search/loop-grid.blade.php ENDPATH**/ ?>