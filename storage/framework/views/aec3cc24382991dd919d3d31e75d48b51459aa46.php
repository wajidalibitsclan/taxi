...
<div class="booking-review">
    <h4 class="booking-review-title d-flex justify-content-start align-items-center" style="font-size:18px;">
        ...
        <a class="d-block d-sm-none ml-auto text-13" href="#"  onclick="$('.booking-review-content').toggleClass('d-none')">HIDE DETAILS</a>
    </h4>
...
<?php /**PATH /Applications/MAMP/htdocs/jamaica_texi/themes/Jamrock/Tour/Views/frontend/booking/detail.blade.php ENDPATH**/ ?>