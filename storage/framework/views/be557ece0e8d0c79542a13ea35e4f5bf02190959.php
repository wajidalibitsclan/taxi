    ...
    <div class="bravo-booking-page padding-content" >
        <div class="container">
            <div id="bravo-checkout-page" >
                <div class="row">
                    <div class="col-md-8">
                        <h4 style="font-size: 15px; margin-left:18px;" class="form-title border-0 mb-2 d-flex justify-content-center align-items-center">
                            <div class="d-flex">
                                <?php echo e(__('LEAD PERSON DETAIL')); ?> |
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saeeccmd/taxi.saeedantechnology.com/themes/BC/Booking/Views/frontend/checkout.blade.php ENDPATH**/ ?>