            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-4">
                        ...
                        <?php echo $__env->make('Tour::frontend.layouts.details.form-book', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="left">
                    <div class="g-price">
                        ...
                        <div class="price">
                            ...
                            <span class="text-price"><?php echo e($row->display_price); ?> <small>PP</small></span>
                        </div>
                    </div>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        var bravo_booking_i18n = {
            ...
            no_gg_distance_select:'<?php echo e(__('Please click search button')); ?>',
    ...
    <script type="text/javascript" src="<?php echo e(asset('themes/jamrock/js/tour/single-tour.js?_ver='.config('app.asset_version'))); ?>"></script>
    <script type="text/javascript" src="/themes/jamrock/libs/timepicker/VueTimepicker.umd.min.js"></script>
    <script type="text/javascript" src="<?php echo e(asset('themes/jamrock/js/tour/form-book.js?_ver='.config('app.asset_version'))); ?>"></script>

<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/saeeccmd/taxi.saeedantechnology.com/themes/Jamrock/Tour/Views/frontend/detail.blade.php ENDPATH**/ ?>