                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label"><?php echo e(__("Display Order")); ?></label>
                                    <input type="number" name="display_order" class="form-control" value="<?php echo e($row->display_order); ?>">
                                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/testing.jamaicataxi.com/htdocs/modules/Car/Views/admin/detail.blade.php ENDPATH**/ ?>