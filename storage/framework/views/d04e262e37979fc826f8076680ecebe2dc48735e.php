    ...
    <div class="bravo-booking-page padding-content" >
        <div class="container">
            <div id="bravo-checkout-page" >
                <div class="row">
                    <div class="col-md-8">
                        <h4 style="font-size: 18px" class="form-title border-0 mb-2 d-flex justify-content-center align-items-center">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/testing.jamaicataxi.com/htdocs/themes/BC/Booking/Views/frontend/checkout.blade.php ENDPATH**/ ?>