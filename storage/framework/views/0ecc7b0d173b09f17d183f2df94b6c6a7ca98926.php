<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('options.admin.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar"><?php echo e($row->id ? __('Edit: ').$row->title : __('Add Dropdown Option')); ?></h1>
                </div>
            </div>
            <input type="hidden" name="dropdown_id" value="<?php echo e($dropdown_id); ?>">
                    ...
                    <div class="col-md-9">
                        <div class="panel">
                            <div class="panel-body">
                                <?php echo $__env->make('Booking::admin.options.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/jamaica_texi/themes/Jamrock/Booking/Views/admin/options/detail.blade.php ENDPATH**/ ?>