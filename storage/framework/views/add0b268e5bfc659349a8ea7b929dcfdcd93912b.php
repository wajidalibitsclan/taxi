...
?>
<div class=" item-loop  <?php echo e($wrap_class ?? ''); ?> bg-white jr-item-tour h-full d-flex flex-column">
            ...
            <div class="extra_box mb-2">
                <div>
                    ...
                    <div class="text-14 font-weight-bold">
                        ...
                        <img src="<?php echo e(asset('themes/jamrock/images/new-image4.png')); ?>" alt="">
                    </div>
                </div>
            </div>
            <div class="extra_box mb-2">
                <div>
                    ...
                    <div class="text-14 font-weight-bold" style="margin-top: 3px;">
                        ...
                        <img style="max-width: 27px !important;" src="<?php echo e(asset('themes/jamrock/images/new-image6.png')); ?>" alt="">
                    </div>
                </div>
            </div>
    ...
    <div class="row px-4">
        <div class="col-6">
            <div class="price_box">
                ...
                <a <?php if(!empty($blank)): ?> target="_blank" <?php endif; ?> href="<?php echo e($row->getDetailUrl($include_param ?? true)); ?>&trip_type=oneway">
        ...
        <div class="col-6">
            <div class="price_box">
                ...
                <a <?php if(!empty($blank)): ?> target="_blank" <?php endif; ?> href="<?php echo e($row->getDetailUrl()); ?>&trip_type=round">
                    <div class="text-14 font-weight-bold">
                        <img style="float: right;width: 15px;" src="<?php echo e(asset('themes/jamrock/images/image20.png')); ?>" alt="">
                    </div>
...
<?php /**PATH /home/saeeccmd/taxi.saeedantechnology.com/themes/Jamrock/Car/Views/frontend/layouts/search/loop-grid.blade.php ENDPATH**/ ?>