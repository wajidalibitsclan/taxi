        ...
        <div class="review-section">
            <ul class="review-list">
                ...
                <?php if($meta = $booking->number): ?>
                    <li>
                        <div class="label text-muted"><?php echo e(__('Persons:')); ?> | Bags</div>
                        <div class="val text-dark">
                            <?php echo e($meta); ?>
...
<?php /**PATH /var/www/testing.jamaicataxi.com/htdocs/themes/Jamrock/Car/Views/frontend/booking/detail.blade.php ENDPATH**/ ?>