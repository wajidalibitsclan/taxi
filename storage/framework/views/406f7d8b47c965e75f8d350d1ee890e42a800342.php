        ...
        <div class="content justify-content-between">
            ...
            <div class="header-right" style="flex-shrink: 0;width: auto">
                ...
                <a href="#" class="bravo-more-menu icon-service h-badge">
                    <span class="">
                        <img src="<?php echo e(asset('themes/jamrock/images/new-image17.png')); ?>" alt="">
                    </span>
                </a>
                <a href="javascript:void(0)" class="icon-service h-badge">
                   <span class="">
                        <img src="<?php echo e(asset('themes/jamrock/images/new-image14.png')); ?>" alt="">
                    </span>
                </a>
                <a href="<?php echo e(route('tour.search')); ?>" class="icon-service h-badge">
                   <span class="">
                        <img src="<?php echo e(asset('themes/jamrock/images/new-image15.png')); ?>" alt="">
                    </span>
                </a>
                <a href="<?php echo e(route('car.search')); ?>" class="icon-service h-badge">
                    <span class="">
                        <img src="<?php echo e(asset('themes/jamrock/images/new-image13.png')); ?>" alt="">
                    </span>
                </a>
    ...
    <div class="bravo-menu-mobile" style="display:none;">
        <div class="user-profile">
            <div class="b-close">
                ...
                <img style="width: 50px" src="<?php echo e(asset('themes/jamrock/images/mobile_manu_close.png')); ?>" alt="">
            </div>
...
<?php /**PATH /home/saeeccmd/taxi.saeedantechnology.com/themes/Jamrock/Layout/parts/header.blade.php ENDPATH**/ ?>