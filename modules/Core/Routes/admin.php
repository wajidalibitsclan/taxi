...
Route::group(['prefix' => 'menu'], function () {
    ...
    Route::get('/link/add', 'MenuController@link')->name('core.admin.link.menu.index');
    Route::post('/link/add', 'MenuController@savelink')->name('core.admin.link.menu.save');
    Route::get('/link/delete/{id}', 'MenuController@deletelink')->name('core.admin.delete.link');
