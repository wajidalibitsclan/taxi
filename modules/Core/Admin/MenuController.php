...
use Modules\Core\Models\LinkMenu;
...
class MenuController extends AdminController
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'linkmenu'       => DB::table('link_menus')->get()
        ];
...
//            'footer'  => __("Footer"),
    ...
    {
        return view('Core::admin.menu.addlink');
    }

    public function savelink(Request $request)
    {
        try {
                $menu = DB::table('link_menus')->insert([
                    'name'  => $request->name,
                    'link'  => $request->link,
                ...
                if($menu)
                {
                    return redirect()->route('core.admin.menu.index')->with('success', 'link menu created successfully');
                }
        } catch (\Throwable $th) {
