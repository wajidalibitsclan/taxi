...
@section('content')
    <div class="container-fluid">
        ...
        <div class="panel">
            <div class="panel-title">{{__('Link Menus')}}</div>
            <div class="panel-body">
            <div class="">
                <a href="{{route('core.admin.link.menu.index')}}" class="btn btn-primary">{{__("Add Link")}}</a>
            </div>
                <form action="" class="bravo-form-item">
                    <table class="table table-hover">
                        <thead>
                        ...
                        @foreach($linkmenu as $link)
                            <tr>
                                ...
                                <td><img src="{{asset('public/images/'.$link->icon)}}" height="50" width="50"/></td>
                                <td><a  href="{{route('core.admin.delete.link', [$link->id] )}}" class="btn btn-danger" >Delete</a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
