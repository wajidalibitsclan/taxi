        ...
        <div class="panel">
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pickup_tooltip" value="{{setting_item('pickup_tooltip')}}" />
                    <br>
                </div>
                <div class="form-group">
                    <label class="" >Return Tooltip</label>
                    <input type="text" class="form-control" name="return_tooltip" value="{{setting_item('return_tooltip')}}" />
                    <br>
                </div>
            </div>
        </div>
